...
export default styled(TextField)(({ theme, ownerState }) => {
  ...
  const { grey,  transparent, error: colorError, success: colorSuccess, white } = palette;
  ...
  const successStyles = () => ({
    ...
    backgroundRepeat: "no-repeat",
    backgroundPosition: `right ${pxToRem(12)} center`,
    backgroundSize: `${pxToRem(25)} ${pxToRem(16)}`,
  ...
  return {
   backgroundColor: disabled ? `${grey[800]} !important` : transparent.main,
